...
public class Task {
    ...
    /**
     * 是否改派线路（0表示未改派 1表示已改派）
     */
    private Integer ischangeroute;

    /**
     * 改派前的标段
     */
    @Column(name = "beforesection_id")
    private Integer beforesectionId;

    /**
     * 修改线路备注
     */
    private String gaixian;

    /**
     * 修改的时间
     */
    private Date gaixiant;
    ...
    /**
     * 获取是否改派线路（0表示未改派 1表示已改派）
     *
     * @return ischangeroute - 是否改派线路（0表示未改派 1表示已改派）
     */
    public Integer getIschangeroute() {
        return ischangeroute;
    }

    /**
     * 设置是否改派线路（0表示未改派 1表示已改派）
     *
     * @param ischangeroute 是否改派线路（0表示未改派 1表示已改派）
     */
    public void setIschangeroute(Integer ischangeroute) {
        this.ischangeroute = ischangeroute;
    }

    /**
     * 获取改派前的标段
     *
     * @return beforesection_id - 改派前的标段
     */
    public Integer getBeforesectionId() {
        return beforesectionId;
    }

    /**
     * 设置改派前的标段
     *
     * @param beforesectionId 改派前的标段
     */
    public void setBeforesectionId(Integer beforesectionId) {
        this.beforesectionId = beforesectionId;
    }

    /**
     * 获取修改线路备注
     *
     * @return gaixian - 修改线路备注
     */
    public String getGaixian() {
        return gaixian;
    }
     ...
     * 设置修改线路备注
     *
     * @param gaixian 修改线路备注
     */
    public void setGaixian(String gaixian) {
        this.gaixian = gaixian;
    }

    /**
     * 获取修改的时间
     *
     * @return gaixiant - 修改的时间
     */
    public Date getGaixiant() {
        return gaixiant;
    }
     ...
     * 设置修改的时间
     *
     * @param gaixiant 修改的时间
     */
    public void setGaixiant(Date gaixiant) {
        this.gaixiant = gaixiant;
    }
}